...
export default function Footer() {
    ...
    return (
        <>
            {(location.pathname === '/payment' || location.pathname === '/') && <div className="row justify-content-between">
                ...
                <div className="col-6 mb-md-0 mb-5">
                    <div className='d-md-flex justify-content-end mt-4'>
                        <a className="col-md-6 btn border border-dark border-3 p-3 m-2 rounded-5" href="/">CONTINUE SHOPPING</a>
